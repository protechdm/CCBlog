...
namespace BlogEngine.Core.Data.Contracts
{
    ...
    public interface IBusinessTypeRepository
    {
        ...
        IEnumerable<Data.Models.BusinessTypeItem> Find(int take = 10, int skip = 0, string filter = "", string order = "");
        /// <summary>
        /// Get single item
        /// </summary>
        /// <param name="id">Item id</param>
        /// <returns>Object</returns>
        Data.Models.BusinessTypeItem FindById(Guid id);
        /// <summary>
        /// Add new item
        /// </summary>
        /// <param name="item">Post</param>
        /// <returns>Saved item with new ID</returns>
        Data.Models.BusinessTypeItem Add(Data.Models.BusinessTypeItem item);
        /// <summary>
        /// Update post
        /// </summary>
        /// <param name="item">Item to update</param>
        /// <returns>True on success</returns>
        bool Update(Data.Models.BusinessTypeItem item);
        /// <summary>
        /// Delete item
        /// </summary>
        /// <param name="id">Item ID</param>
